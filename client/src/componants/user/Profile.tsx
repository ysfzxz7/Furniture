      ...
      <div className="bg-white rounded w-fit px-3 py-5 shadow-2xl ">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-2 items-end  ">
            <h3>Username : </h3>
            <h3 className=" font-semibold text-xs mb-[3px]">Simo@jallal.com</h3>
          </div>
          <div className="flex gap-2 items-end  ">
            <h3>Number : </h3>
            <h3 className=" font-semibold text-xs mb-[3px]">06153415413</h3>
          </div>
          <div className="flex gap-2 items-end  ">
            <h3> Email: </h3>
            <h3 className=" font-semibold text-xs mb-[3px]">Simo@gmail.com</h3>
          </div>
          ...
          <div className="flex justify-end ">
            <Link
              ...
              className="bg-blue-600 font-bold cursor-pointer text-white text-xs px-3 py-1 rounded flex  items-center gap-2  hover:bg-blue-700"
            >
              Log Out
